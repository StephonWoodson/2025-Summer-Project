...
* Once you have run the Simulink program you will see the estimated blood pressure to the right at the end of the code in the display window named "pressure at point two1" in simulink. In matlab the estimated blood pressure will be in the command window.
...
i. The estimated blood pressure will show in a display window towards the right in simulink. In matlab the estimated blood pressure will display in the command window.
19.The only variables that will stay constant is V2_mps, P1_Pa, p_kgpm3, x0, pi_nd, and r0_m.
20. sig_m will be the width of plaque buildup. I advise this number to stay around 0.0009 as you become more familiar with the formula. However, this number can be anything as long as it stays realistic to the width of a coronary artery. Meaning it cannot be too large or too small.
